...
const postsSlice = createSlice({
	...
	reducers: {
		...
		updatePagePosts(state, action) {
			state.postsPage.page = action.payload
		},
		endPagePosts(state) {
			state.postsPage.page = 'end'
		}
	},
...
export const { removePostsState, updatePagePosts, endPagePosts } = postsSlice.actions
